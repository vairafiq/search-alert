...
<div class="searchalert search_alert_import">
	...
	<input type="submit" name="searchalert_import" id="post-query-submit" class="button searchalert_import" value="<?php esc_html_e( 'Import Subscribers from CSV', 'searchalert' ); ?>">	
</div>
