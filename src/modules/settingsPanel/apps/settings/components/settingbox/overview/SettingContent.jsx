    ...
    const SettingContentData = [
        {
            ...
            content: [
                ...
                },
                {
                    ...
                    component: <Multiselect selectionLimit='10' selectedValues={included_single_post} onSelect={handlEincluded_single_post} placeholder="Select Post Types" options={searchAlert_SettingsScriptData.wp_post_types} displayValue="title" />
                },
                {
                    label: "Email Subject",
